      ...
      <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
        <div className='text-white text-2xl hover:text-celeste transition-colors duration-300 ease-in-out transform'>
          <Link to='/'>
            <img
              src={Logo}
              alt='Logo Pierluigi Papa WD'
              className='h-32 w-32 object-contain items-center'
            />
          </Link>
        </div>
        ...
        <div className='hidden md:block md:w-auto'>
          <ul className='flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0'>
            <li>
              <Link
                to='/'
                className='block py-2 px-3 text-white md:p-0 md:hover:text-celeste transition-colors duration-300 ease-in-out transform'
              >
                Home
              </Link>
            </li>
            <li>
              <Link
                to='/chi-sono'
                className='block py-2 px-3 text-white hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-celeste transition-colors duration-300 ease-in-out transform md:p-0'
              >
                Chi sono
              </Link>
            </li>
