            ...
            <div className="flex flex-col md:flex-row items-center justify-center max-w-screen-xl mx-auto">
                ...
                <div className="w-full flex justify-center mb-10 md:mb-0">
                    <div className="flex flex-col text-center md:text-left">
                        ...
                        <p
                            className={`text-white text-2xl sm:text-3xl md:text-4xl font-normal transition-opacity duration-500 my-2 ${
                        ...
                        {/* SOCIAL & CTA */}
                        <div className="my-4 -ml-2 flex justify-center md:justify-start">
