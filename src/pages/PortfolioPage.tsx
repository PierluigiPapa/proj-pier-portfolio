    ...
    return (
        <>
            <div className="bg-gradient-to-t from-gray-1 to-gray-2">
                <div className="flex flex-row md:flex-row items-center justify-center max-w-screen-xl mx-auto">
                ...
                >
                    {progetti.map((progetto) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                <h3 className="text-xl text-center font-bold text-white mt-2 mb-2">{progetto.titolo}</h3>
                                <span className="text-white text-center">
                                    {progetto.descrizione.includes('.') ? progetto.descrizione.slice(0, progetto.descrizione.indexOf('.') + 1) : progetto.descrizione}
                                </span>
                            </div>

                            <div className="flex justify-center items-center">
                                <button className="h-10 w-40 bg-white rounded-xl border-2 text-celeste hover:bg-celeste hover:text-white mb-3">
                                    <a href={`/progetti/${progetto.titolo}`}>
