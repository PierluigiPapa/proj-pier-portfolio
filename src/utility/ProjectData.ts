...
export const progetti: Portfolio[] = [
    ...
    },
    {
        id: 2,
        titolo: "Card Pokémon",
        descrizione: "Card Pokémon è un progetto ispirato al celebre franchise, sviluppato per creare un'interfaccia interattiva e visivamente accattivante. Permette di cercare un Pokémon digitandone il nome, visualizzare una card personalizzata con immagine, numero, tipologia, statistiche e versione shiny. Include uno spinner animato a tema Poké Ball durante il caricamento e la traduzione delle tipologie in italiano per un'esperienza più immersiva.",
        immagine: Project[1],
        ...
        caratteristiche: ["Stile personalizzato della card con barre delle statistiche",
